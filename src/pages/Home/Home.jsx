...
import tb_about_images from '../../assets/tb-about-images.png';
import tb_services from '../../assets/tb-services-img.png';
import special_img_1 from '../../assets/special-img-01.jpg';
import special_img_2 from '../../assets/special-img-02.jpg';
import testimonial_bg from '../../assets/testimonial-bg.jpg';
import special_bg from '../../assets/special-bg.png';
...
const Home = () => {
  return (
    <>
      {/* Hero Section */}
      <section
        className="hero bg-cover bg-center w-full min-h-screen text-white relative overflow-x-hidden"
        style={{ backgroundImage: `url(${slider_img_1})` }}
      >
      ...
      <section className="w-full lg:flex px-6 sm:px-12">
        ...
        <div className="lg:w-1/3 w-full flex justify-center items-center py-12">
          <FloatBurger burgerlink={tb_services} />
        </div>
      </section>

      {/* Specials Section */}
      <section className="special after:bg-[] w-full flex flex-wrap py-12 sm:py-24 px-6 sm:px-12" style={{ backgroundImage: `url(${special_bg})` }}>
        <div className="md:w-1/2 w-full flex flex-wrap">
          {[special_img_1, special_img_2].map((img, idx) => (
