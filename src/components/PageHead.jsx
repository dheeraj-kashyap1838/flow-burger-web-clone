...
import bread_crumb from '../assets/bread-crumb-img.jpg'

const PageHead = ({page_name}) => {
    return (
        <div className='w-full relative top-0 bg-slate-600  after:absolute after:w-full after:h-2 after:bg-yellow-500 bottom-0 right-0'>
            <img className='w-full relative' src={bread_crumb} alt="#" />
